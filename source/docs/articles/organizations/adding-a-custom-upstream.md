...
<div class="alert alert-info" role="alert">
<h4>Note</h4>
For private repositories, create a dedicated, read-only user with access to the repository. This should be custom/specific to the repository. Do not re-use a common user across projects.</div>
