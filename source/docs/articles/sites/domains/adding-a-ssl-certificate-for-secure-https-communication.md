...
"HTTPS is enabled for the Live environment with loadbalancer IP: X.X.X.X" under the **HTTPS** tab. The **Domains** tab will be updated with new DNS recommendations.
